...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_file', type=str, default='test4.mp4',help='file path of the video')
    parser.add_argument('--tracknet_file', type=str, default='ckpts/TrackNet_best.pt',help='file path of the TrackNet model checkpoint')
    parser.add_argument('--inpaintnet_file', type=str, default='ckpts/InpaintNet_best.pt', help='file path of the InpaintNet model checkpoint')
    ...
    if args.output_video or output_vid:
